...
namespace Lib.System
{
    ...
    /// </code>
    /// </example>
    public class RegistryMonitorFunctions : IDisposable
	{
		#region P/Invoke
		...
		public RegistryMonitorFunctions(RegistryKey registryKey)
		{
		...
		public RegistryMonitorFunctions(string name)
		{
		...
		public RegistryMonitorFunctions(RegistryHive registryHive, string subKey)
		{
